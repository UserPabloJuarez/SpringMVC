                    ...
                    <mvc:form modelAttribute="usuarioBean" action="usuarioGrabar.htm">
                        <table>
                            <tr>
                                ...
                                <td><mvc:input path="usuario" cssErrorClass="form-control text-box formFieldError"
                            ...
                            <tr>
                                ...
                                <td><mvc:input path="nombreCompleto" cssErrorClass="form-control text-box formFieldError"
                                           cssClass="form-control text-box"/></td>
